...
excerpt: >-
  ...
  generation, more open source code is being created today than ever before.
  Yet, s
categories:
  - Development
  - Open Source
...
A perfect example of this shift comes from Dries Buytaert, the founder of Drupal. In a [recent blog post](https://dri.es/adaptable-drupal-modules-code-meant-to-be-adapted-not-installed), Dries discussed “Adaptable Modules.” These are site-specific pieces of code that are not meant to be installed, but rather used as a starting point for AI to reshape.
...
Read my next post about [the generalization tax](/wordpress-architecture-base-ai/), and why I still think WordPress is a great base for AI.
