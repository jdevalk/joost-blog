...
Cloudflare recently launched [isitagentready.com](https://isitagentready.com), a tool that scans your site across five categories and gives you a score out of 100. I ran joost.blog through it, got a 25, and immediately started working through the list. If you use [Alfred](https://www.alfredapp.com/), I added an `agent` command to [Quix](/code/alfred-quix/) that opens the tool for the current browser URL.
