...
featureImage:
  ...
  alt: 'Illustration for: The unintended consequences of making SEO “for everyone”'
---
...
A lot of what we did still matters. The readability checks in Yoast SEO were Marieke’s idea, rooted in her belief that to get as big an audience as possible for your ideas, you need to make them more easily understood. We hired a team of language scientists to research and build them. They were grounded in years of academic work on what makes text understandable, including [shorter sentences](https://yoast.com/the-sentence-length-check/), clear [transitions](https://yoast.com/transition-words-why-and-how-to-use-them/), and [active voice](https://yoast.com/the-passive-voice-what-is-it-and-how-to-avoid-it/). These principles are still incredibly relevant, especially in an AI-powered world.

For instance, we also [talked about paragraphs needing to be about one topic](https://yoast.com/paragraph-length-check/) (and not too long), with a clear use of headings throughout. SEOs now talk about this and then call it “chunking.” They talk about writing for LLMs as much as for people. But the truth is, this was always about helping readers make sense of content. And it still works.
...
With [Progress Planner](https://progressplanner.com)**,** we’re building tools that support thoughtful website SEO strategies. Tools that don’t just help you publish, but help you manage what you’ve already written. Tools that reflect the full life cycle of content: writing, improving, and pruning.

In the [previous release](https://progressplanner.com/progress-planners-new-integration-with-yoast/), we added nudges that’ll help you set up Yoast SEO better, configuring things that matter, but that we know people often get wrong. We plan to do this for more plugins.

In the [upcoming release](https://progressplanner.com/why-writing-more-content-isnt-always-better/), we’ll remove features that reward volume for volume’s sake. We’re doubling down on usefulness, clarity, and long-term website performance.
