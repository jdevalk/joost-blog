---
title: 'The generalization tax: why WordPress is still the <em>smart</em> architectural base'
seo:
...
excerpt: >-
  ...
  what Dries referred to as the generalization tax. This had me thinking more
  about wh
categories:
  - Development
  - WordPress
...
1. **The standardized logic:** WordPress handles the “boring” but critical logic (Users, Auth, Database, Security) that has been battle-tested over two decades.
2. **The battle-tested infrastructure:** By using a generalized base for basic needs, you ensure that your custom features are built on a foundation that receives global security updates.
3. **The architect’s canvas:** The [modern architect](/rise-architect/) might use AI to build high-value custom plugins on top of this base, rather than wasting time reinventing the wheel.
...
Read my next post to understand why I think [vibe coding is a trap](/vibe-coding-trap-design-system/).
