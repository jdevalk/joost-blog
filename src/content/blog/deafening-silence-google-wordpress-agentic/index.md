...
excerpt: >-
  ...
  biggest platform on the web wasn’t even in the room.
categories:
  - Open Source
  - WordPress
---
...
You can read the full announcement here: [New tech and tools for retailers to succeed in an agentic shopping era](https://blog.google/products/ads-commerce/agentic-commerce-ai-tools-protocol-retailers-platforms/).
...
This is exactly why initiatives like **[FAIR](https://fair.pm/)** are becoming critical. We need a neutral, decentralized body that can represent the *business interests* of the WordPress ecosystem (the companies I mentioned above and the many others out there) without being tied to a single company’s roadmap.
