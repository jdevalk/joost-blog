...
- I use [Plausible Analytics](https://plausible.io/) to understand how visitors use my site. Plausible is privacy-friendly and fully compliant with GDPR. It doesn’t use cookies or collect personal data.
...
This data is processed by Cloudflare to determine whether the interaction is from a human, or automated (e.g., from a bot). For more information about how Cloudflare processes this data, please refer to [Cloudflare’s Privacy Policy](https://www.cloudflare.com/privacypolicy/).
...
- I don’t share your data with anyone, ever, except perhaps with my team at [Emilia Capital](https://emilia.capital/) if your inquiry makes that necessary (for instance for fixing bugs, or for setting up meetings).

## Your rights

- You can request to see, update, or delete any personal data I have about you. Just [contact me here](/contact-me/).
