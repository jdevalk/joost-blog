...
![](./images/cropped-joost-de-valk-profile-picture-web.jpg)

<div class="not-prose flex flex-wrap gap-2 my-6">
  <a href="https://gravatar.com/joostdevalk" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-semibold bg-slate-100 text-slate-700 hover:bg-primary hover:text-white dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-primary transition-colors duration-200">
    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.37 0 0 5.37 0 12s5.37 12 12 12 12-5.37 12-12S18.63 0 12 0zm0 3.6c2.32 0 4.2 1.88 4.2 4.2S14.32 12 12 12s-4.2-1.88-4.2-4.2S9.68 3.6 12 3.6zm0 17.04c-2.97 0-5.58-1.53-7.11-3.84C5.07 14.88 9.6 13.8 12 13.8s6.93 1.08 7.11 2.99c-1.53 2.32-4.14 3.84-7.11 3.84z"/></svg>
    Gravatar
  </a>
  <a href="https://github.com/jdevalk" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-semibold bg-slate-100 text-slate-700 hover:bg-primary hover:text-white dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-primary transition-colors duration-200">
  ...
  <a href="https://www.linkedin.com/in/jdevalk/" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-semibold bg-slate-100 text-slate-700 hover:bg-primary hover:text-white dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-primary transition-colors duration-200">
    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
    LinkedIn
  </a>
  <a href="https://bsky.app/profile/joost.blog" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-semibold bg-slate-100 text-slate-700 hover:bg-primary hover:text-white dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-primary transition-colors duration-200">
  ...
  <a href="https://www.threads.net/@joostdevalk" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-semibold bg-slate-100 text-slate-700 hover:bg-primary hover:text-white dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-primary transition-colors duration-200">
  ...
  <a href="https://profiles.wordpress.org/joostdevalk" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-semibold bg-slate-100 text-slate-700 hover:bg-primary hover:text-white dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-primary transition-colors duration-200">
    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M21.469 6.825c.84 1.537 1.318 3.3 1.318 5.175 0 3.979-2.156 7.456-5.363 9.325l3.295-9.527c.615-1.54.82-2.771.82-3.864 0-.405-.027-.78-.07-1.109m-7.981.105c.647-.034 1.233-.1 1.233-.1.584-.068.516-.928-.068-.895 0 0-1.755.138-2.89.138-1.067 0-2.872-.138-2.872-.138-.583-.033-.65.861-.066.895 0 0 .554.066 1.134.1l1.684 4.622-2.37 7.108L5.691 6.93c.649-.034 1.236-.1 1.236-.1.585-.068.516-.928-.067-.895 0 0-1.755.138-2.89.138-.203 0-.443-.005-.693-.014C4.952 3.012 8.19 1.126 11.87 1.126c2.741 0 5.238 1.049 7.109 2.766-.045-.003-.089-.009-.136-.009-1.067 0-1.823.929-1.823 1.928 0 .895.516 1.654 1.067 2.55.414.717.895 1.636.895 2.963 0 .92-.354 1.989-.82 3.477l-1.075 3.591-3.894-11.567h.001zm-3.62 15.58A10.894 10.894 0 011.124 12c0-1.593.34-3.104.953-4.472l5.25 14.382c.009.021.018.042.028.062zM11.87 0C5.318 0 0 5.318 0 11.87S5.318 24 11.87 24c6.553 0 12-5.318 12-12.13C23.87 5.318 18.423 0 11.87 0z"/></svg>
    WordPress
  </a>
  <a href="https://www.instagram.com/joostdevalk" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-semibold bg-slate-100 text-slate-700 hover:bg-primary hover:text-white dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-primary transition-colors duration-200">
  ...
  <a href="https://joost.net/@joost" rel="me" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-semibold bg-slate-100 text-slate-700 hover:bg-primary hover:text-white dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-primary transition-colors duration-200">
...
<div class="not-prose grid grid-cols-2 sm:grid-cols-3 gap-4">
  <a href="/videos/sustainable-open-source-is-the-future/" class="group">
    <img src="/images/videos/wceu-keynote.webp" alt="Sustainable open source is the future" class="rounded-lg aspect-video object-cover w-full transition-transform duration-300 group-hover:scale-105" />
  ...
  <a href="/videos/improve-the-environment-start-with-your-website/" class="group">
    <img src="/images/videos/less-crawling-still-1.png" alt="Improve the environment. Start with your website!" class="rounded-lg aspect-video object-cover w-full transition-transform duration-300 group-hover:scale-105" />
  ...
  <a href="/videos/wordpress-seo-in-2019/" class="group">
    <img src="/images/videos/joost-de-valk-wordcamp-athens-2019.png" alt="WordPress SEO in 2019" class="rounded-lg aspect-video object-cover w-full transition-transform duration-300 group-hover:scale-105" />
  ...
  <a href="/videos/why-timestamping-will-be-good-for-seo/" class="group">
    <img src="/images/videos/joost-de-valk-timestamping-wordproof.png" alt="Why timestamping will be good for SEO" class="rounded-lg aspect-video object-cover w-full transition-transform duration-300 group-hover:scale-105" />
  ...
  <a href="/videos/the-victory-of-the-commons/" class="group">
    <img src="/images/videos/joost-de-valk-wordcamp-europe-leiden-2013.png" alt="The victory of the commons" class="rounded-lg aspect-video object-cover w-full transition-transform duration-300 group-hover:scale-105" />
  ...
  <a href="/videos/the-business-of-open-source/" class="group">
    <img src="/images/videos/joost-de-valk-wordcamp-us-nashville-2018.png" alt="The business of open source" class="rounded-lg aspect-video object-cover w-full transition-transform duration-300 group-hover:scale-105" />
