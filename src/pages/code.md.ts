...
- [Sitemap Inspector](/code/sitemap-inspector/) — free Chrome extension for browsing XML sitemaps, finding sitemap issues, and checking URLs and Googlebot robots.txt rules.
